          ...
          >
            {isPatching && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-10 rounded-2xl">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-xs font-medium text-indigo-400 bg-indigo-500/10 px-3 py-1 rounded-full border border-indigo-500/20">Refactoring Tech Stack...</span>
                </div>
              </div>
            )}
            <div className="flex items-center justify-between">
            ...
            <form onSubmit={handleChatPatch} className="relative">
              <input
                disabled={isPatching}
                type="text"
                placeholder="e.g. 'Switch React to Vue' or 'Use MongoDB instead'"
                className="w-full bg-[#0a0a0a] border border-[#333] focus:border-indigo-500/50 rounded-xl px-4 py-3 pb-8 text-sm text-neutral-200 placeholder:text-neutral-600 focus:outline-none transition-all disabled:opacity-50"
                value={chatMessage}
                onChange={(e) => setChatMessage(e.target.value)}
              />
          ...
          >
            {isPatching && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-10 rounded-2xl">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <span className="text-xs font-medium text-indigo-400 bg-indigo-500/10 px-3 py-1 rounded-full border border-indigo-500/20">Refactoring SQL Schema...</span>
                </div>
              </div>
            )}
            <div className="flex items-center justify-between">
            ...
            <form onSubmit={handleChatPatch} className="relative">
              <input
                disabled={isPatching}
                type="text"
                placeholder="e.g. 'Add a column for phone number' or 'Add indices'"
                className="w-full bg-[#0a0a0a] border border-[#333] focus:border-indigo-500/50 rounded-xl px-4 py-3 pb-8 text-sm text-neutral-200 placeholder:text-neutral-600 focus:outline-none transition-all disabled:opacity-50"
                value={chatMessage}
                onChange={(e) => setChatMessage(e.target.value)}
              />
