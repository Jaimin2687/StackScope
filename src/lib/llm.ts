...
MANDATORY JSON SHAPE (core keys must exist):
{
  ...
  "market_analysis": {
    "viability_score": number, // Scale 0-100 (e.g. 85. NEVER use 1-10)
    "reasoning": string,
    "competitors": string[]
  },
