...
const SCOPE_RESPONSE_SCHEMA = {
  ...
  required: ["proposal", "sprint_timeline", "tech_stack", "sql_schema"],
} as Schema;
...
4. DATABASE SCHEMA: You MUST output raw, deployable PostgreSQL CREATE TABLE statements optimized specifically for Supabase. This includes:
